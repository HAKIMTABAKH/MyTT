...
const navigation = {
  solutions: [
    { name: "Internet Plans", href: "/products" },
    { name: "Business Solutions", href: "/business" },
    { name: "Router Installation", href: "/services" },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-primary">Telecom Tunisie</span>
            </Link>
            <p className="text-sm leading-6 text-muted-foreground">
              Your trusted communications partner, delivering reliable internet and telecommunications services across Tunisia.
            </p>
        ...
        <div className="mt-16 border-t pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-muted-foreground">
            &copy; {new Date().getFullYear()} Telecom Tunisie. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
